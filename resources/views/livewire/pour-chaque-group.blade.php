<div>
    ...
    {{-- end select date --}}
            ...
            {{-- modal Search --}}
                <div style="margin-left:100px" class=" SearchContainer rounded">
                    <div style="  display:flex ; height:35px;">
                        <input id='searchInput12' style="width: 150px ; height:100%;" type="search" class="form-control rounded searchDev hide " placeholder="Search" aria-label="Search" aria-describedby="search-addon" />
                        <div class="selectDiv hide" style="margin-right: 15px;margin-left: 15px">
                                <select style="width: 150px" wire:model="groupID" id="selectOptions12" class="form-control col-3" name="">
                                    <option > les Groupes</option>
                                    @foreach ($groups as $group)
                                          <option class="form-control"  value="{{$group->id}}">{{$group->group_name}} </option>
                                    @endforeach
                        ...
                        <div class="selectDiv hide" style="margin-right: 15px;margin-left: 15px">
                        <select id='date-select' class="form-select " style="width: 200px"  wire:model="selectedValue" wire:change="updateSelectedIDEmploi($event.target.value)">
                            <option >Select date emploi</option>
                            @forEach( $Main_emplois as $Main_emploi)
                                <option value="{{ $Main_emploi->id }}">{{$Main_emploi->datestart  }} to {{$Main_emploi->dateend }}</option>
                            @endforeach
            ...
            <table id="myTable" style="overflow:scroll " class="col-md-12 ">
                ...
                @endif
                         ...
                         {{-- Model --}}
                         <div style="z-index:99999999999999999" wire:ignore.self  class="modal fade col-9 wrapper" id="exampleModal" tabindex="-1"
