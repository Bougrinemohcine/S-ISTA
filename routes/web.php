...
use App\Http\Controllers\stagiaireController;
    ...
    */
    ...
    Route::middleware(['auth', 'RoutesForFormateur'])->group(function () {
        ...
        // displat main page in stagiaire account
        ...
        Route::post('/updateSession', [FormateurRequestController::class, 'updateSession'])->name('updateSession');
    ...
    Route::middleware(['auth', 'RoutesForStagiaire'])->group(function(){
        Route::get('/dashboardStagiare', [stagiaireController::class, 'showHomepage'])->name('dashboard_stagiaire');
    });
